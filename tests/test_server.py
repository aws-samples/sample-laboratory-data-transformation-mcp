...
"""Tests for the allotrope MCP Server."""

import pytest
from awslabs.allotrope_mcp_server.server import example_tool
from awslabs.allotrope_mcp_server.server import math_tool

@pytest.mark.asyncio
async def test_example_tool():
    # Arrange
    test_query = "test query"
    expected_project_name = "awslabs allotrope MCP Server"
